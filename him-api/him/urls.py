...
urlpatterns = [
    ...
    path(
        "bot/send-first-messages/",
        views.bot_send_first_messages,
        name="bot_send_first_messages",
    ),
    path(
        "bot/chat-with-matches/",
        views.bot_chat_with_matches,
        name="bot_chat_with_matches",
    ),
